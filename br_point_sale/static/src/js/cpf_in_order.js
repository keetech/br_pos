odoo.define('br_point_sale.cpfnanota', function (require) {
"use strict";
...
var CPFButton = screens.ActionButtonWidget.extend({
    ...
    button_click: function(){
        var self = this;
        this.gui.show_popup('number-cpf',{
            'title': _t('CPF na Nota'),
            'value': '',
            /*
...
screens.define_action_button({'name': 'cpfnanota','widget': CPFButton});
